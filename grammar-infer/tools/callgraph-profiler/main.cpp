...
static cl::OptionCategory callProfilerCategory{"call profiler options"};
...
static void
saveModule(Module& m, StringRef filename) {
  std::error_code errc;
...
main(int argc, char** argv) {
  ...
  cl::HideUnrelatedOptions(callProfilerCategory);
